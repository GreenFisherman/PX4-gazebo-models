...
the water's edge, facing west into the lake. The terrain is registered to this
position; the old lake-centre GPS assumption is no longer used.
...
The corrected layout was tested in isolated PX4/Gazebo: home matched the beach
GPS coordinates, the boat faced west, preflight checks passed, and a
two-waypoint mission from the beach launch completed without a failsafe.
